  ...
  <section className="bg-[#F5F5F5] px-6 py-24">
    <div className="max-w-4xl mx-auto">
      <div className="testimonial-card relative rounded-3xl bg-[#2B2644] p-10 md:p-16 overflow-hidden">
        ...
        >
          "After three months I finally know where my salary goes. The daily allowance feature
          alone saved me from overdraft twice."
        </p>
        <div className="flex items-center gap-4 pl-6">
          ...
          <div>
            <p className="text-white font-medium">Priya K.</p>
            <p className="text-sm text-white/50">Software engineer · Mumbai</p>
          </div>
